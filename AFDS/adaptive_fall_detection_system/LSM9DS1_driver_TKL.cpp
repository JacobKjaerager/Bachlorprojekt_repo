...
void LSM9DS1Class::init(){
  ...
  settings.gyro.sampleRate = 1;					/**<  Samplerate for gyro (by using 1-6 corresponding to 14.9, 59.5, 119, 238, 476 or 952 Hz)*/
  ...
  settings.accel.scale = 16;							/**<	Scale (2, 4, 8 or 16 g's ) (Lower is finer resolution)		*/
  ...
  //  MAG SETTINGS
  settings.mag.enabled = false;		  					/**<	Enabling mag on all axes		*/
