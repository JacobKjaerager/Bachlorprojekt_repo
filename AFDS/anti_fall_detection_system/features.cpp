...
void feature_calculation(float calc_feat[], float acc_x_sig[], float acc_y_sig[],
  ...
  // Instanciate magnitude calculation variable
  ...
  // Run through signal again to calculate standard deviation
  for (int index = 0; index < signal_len; index++) {
  ...
  float max_std = 0;
  float max_std_hoz = 0;
  for (int index = 0; index < signal_len-20; index++) {
    for (int i = 0; i < 20; i++) {
