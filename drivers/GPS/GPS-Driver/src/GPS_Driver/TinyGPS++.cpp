...
void DetailedSateliteData::setElevation(const char *term){ newElevation = atoi(term); }
void DetailedSateliteData::setAzimuth(const char *term){ newAzimuth = atoi(term); }
